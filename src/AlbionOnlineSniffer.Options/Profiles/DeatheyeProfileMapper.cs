...
/// </summary>
public interface IDeatheyeProfileMapper
{
    /// <summary>
    /// Loads profiles from deatheye settings directory
    /// </summary>
    Task<List<ProfileOptions>> LoadDeatheyeProfilesAsync(string settingsPath);
    
    /// <summary>
    /// Maps deatheye settings to profile options
    /// </summary>
    ProfileOptions MapDeatheyeSettings(DeatheyeSettings settings);
}

/// <summary>
/// Deatheye settings structure
/// </summary>
public class DeatheyeSettings
{
...
/// </summary>
public class DeatheyeProfileMapper : IDeatheyeProfileMapper
{
    private readonly ILogger<DeatheyeProfileMapper> _logger;
    
    public DeatheyeProfileMapper(ILogger<DeatheyeProfileMapper> logger)
    {
        _logger = logger;
    }
    
    public async Task<List<ProfileOptions>> LoadDeatheyeProfilesAsync(string settingsPath)
    {
        ...
        foreach (var file in settingsFiles)
        {
            try
            {
                ...
                var settings = JsonSerializer.Deserialize<DeatheyeSettings>(json, new JsonSerializerOptions
                {
                ...
                if (settings != null)
                {
                    var profile = MapDeatheyeSettings(settings);
    ...
    public ProfileOptions MapDeatheyeSettings(DeatheyeSettings settings)
    {
    ...
    private string? MapFeatureName(string deatheyeFeature)
    {
        return deatheyeFeature.ToLowerInvariant() switch
        {
    ...
    private string? MapThresholdName(string deatheyeThreshold)
    {
        return deatheyeThreshold.ToLowerInvariant() switch
        {
