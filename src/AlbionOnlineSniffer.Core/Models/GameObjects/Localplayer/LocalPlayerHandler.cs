...
using AlbionOnlineSniffer.Core.Models.Dependencies.Template;
...
namespace AlbionOnlineSniffer.Core.Models.GameObjects.Localplayer
{
    ...
    {
        public AlbionOnlineSniffer.Core.Models.GameObjects.Localplayer.LocalPlayer localPlayer = new AlbionOnlineSniffer.Core.Models.GameObjects.Localplayer.LocalPlayer();
