...
using Albion.Sniffer.Core.Models.Dependencies.Template;
using Albion.Sniffer.Core.Models.Events;
using Albion.Sniffer.Core.Utility;

namespace Albion.Sniffer.Core.Models.GameObjects.Localplayer
{
    [Obfuscation(Feature = "mutation", Exclude = false)]
    public class LocalPlayerHandler
    {
        public Albion.Sniffer.Core.Models.GameObjects.Localplayer.LocalPlayer localPlayer = new Albion.Sniffer.Core.Models.GameObjects.Localplayer.LocalPlayer();
